...
namespace Exceptions
{
    class Program
    {
        ...
        static void ThrowException(string exceptionType)
        {
            ...
            {
                case "none":
                    Console.WriteLine("Not throwing an exception."); break;
                case "simple":
                ...
                case "nested index":
                    ...
                    {
                        Console.WriteLine("ThroweException(\"nested index\") general catch block reached.");
                    }
                    finally
                    {
                        Console.WriteLine("ThroweException(\"nested index\") finally block reached. ");
                    }
                    break;
                case "filter":
                    try
